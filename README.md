...
- `data/` → Raw parquet datasets used for modeling
  
- `src/` → Data collection API scrappers, EDA, and modeling scripts
  
- `outputs/` → Master Excel sheet of all processed data
  
- `paper/` → Final submitted capstone paper (PDF)
